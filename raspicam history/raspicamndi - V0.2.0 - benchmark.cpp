...
int main ( int argc,char **argv ) {
	...
	auto Chronometrations_starts = std::chrono::high_resolution_clock::now();
	...
	auto Chronometrations_ends = std::chrono::high_resolution_clock::now();
	std::chrono::duration<double, std::milli> Chronometrations_time = Chronometrations_ends - Chronometrations_starts;
	std::cout<<Chronometrations_time.count()<<" millisecond for sending 100 frames at "<<(video_frame.frame_rate_N/video_frame.frame_rate_D)<<" fps"<<std::endl;
